package b1.uts2003040151.muhammadnaufalnuraziz
...
class HomeActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(target: AdapterView<*>?, p1: View?, position: Int, p3: Long) {
    ...
    override fun onClick(button: View?) {
        ...
        if(button?.id == R.id.btnHitung) {
            if(beratBadan.text.toString() == "" || tinggiBadan.text.toString() == "") {
                ...
                if(spinnerJenisKelamin == "Laki-laki") {
                    if (bmi < 17) {
